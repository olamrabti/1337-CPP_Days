...
Form::Form(std::string name, size_t s_grade, size_t e_grade) : form_name(name), _signed(false), sign_grade(s_grade), exec_grade(e_grade)
{
}
...
{
	if (b.getGrade() < sign_grade) // later
		_signed = true;
	else
