...
{
    std::cout << "Contructor called : " << _name << " is Ready as a ClapTrap..." << std::endl;
}
...
ClapTrap::~ClapTrap()
{
    std::cout << "Destructor called : ClapTrap " << _name << " is Destoyed." << std::endl;
}
...
void ClapTrap::attack(const std::string &target)
{
    ...
    if (_hit_pts > 0)
    {
        ...
        std::cout << "Oops! " << _name << " Cant Attack now ! He is probably dead!" << std::endl;
    return;
}
